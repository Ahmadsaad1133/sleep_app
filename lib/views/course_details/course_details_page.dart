                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TabBar(
                      ...
                      tabs: [
                        Tab(child: Align(alignment: Alignment.centerLeft, child: Text('MALE VOICE', style: TextStyle(fontFamily: 'HelveticaNeue', fontSize: 16 * scale)))),
                        Tab(child: Center(child: Text('FEMALE VOICE', style: TextStyle(fontFamily: 'HelveticaNeue', fontSize: 16 * scale)))),
                      ],
                    ),
                    Container(
                      height: 400 * scale,
      ...
      child: Row(
        children: [
          Container(
            width: 48 * scale,
            height: 48 * scale,
            decoration: BoxDecoration(shape: BoxShape.circle, border: Border.all(color: const Color(0xFFE0E0E0), width: 1 * scale)),
            child: Icon(Icons.play_arrow, size: 24 * scale, color: const Color(0xFF6C63FF)),
          ),
          SizedBox(width: 16 * scale),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(title, style: TextStyle(fontFamily: 'HelveticaNeue', fontSize: 16 * scale, fontWeight: FontWeight.w600)),
              SizedBox(height: 4 * scale),
              Text('${minutes} MIN', style: TextStyle(fontFamily: 'HelveticaNeue', fontSize: 12 * scale, fontWeight: FontWeight.w400)),
            ],
          ),
        ],
      ),
